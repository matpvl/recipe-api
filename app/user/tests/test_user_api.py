...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        ...
        # We assert that the password is hashed and can not be retrieved via payload.
    ...
    def test_password_too_short_error(self):
        ...
        # We create a user with given payload
        res = self.client.post(CREATE_USER_URL, payload)

        # We check that we are given a bad request status code.
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
        # We check that the user hasn't been created in the database.
    ...
    def test_retrieve_user_unauthorized(self):
        ...
        # We give an unauthenticated request.
