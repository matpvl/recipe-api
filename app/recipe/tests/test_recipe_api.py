...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        # We have to add format="json", because we're working with nested objects.
        ...
        # We check that the correct tags were assigned to the correct user.
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        # We test that the existing tag is given to our Recipe,
        # instead of creating a duplicate tag.
    ...
    def test_udpdate_recipe_assign_tag(self):
        ...
        # We patched the recipe, so tag_breakfest shouldn't be inside it
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title="red Lentin Daal")
